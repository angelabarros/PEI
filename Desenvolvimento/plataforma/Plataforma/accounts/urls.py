...
from .api import RegisterBidderAPI,UpdateBidderAPI,UpdateProponentAPI, RegisterProponentAPI, ListBiddersAPI, LoginBidderAPI, LoginProponentAPI, UserAPI,ReviewAPI
...
urlpatterns = [
    ...
    path('api/auth/review',ReviewAPI.as_view()),
